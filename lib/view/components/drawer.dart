...
class _CustomDrawerState extends State<CustomDrawer> {
      ...
      child: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xff082033), Color(0xff081D30)],
        ...
        child: ListView(
          padding: EdgeInsets.only(top: Get.width / 8),
          children: [
            Padding(
            ...
            Divider(color: Color(0xff536674)),
            Padding(
  ...
  Widget _drawerTile(String image, String title, {bool trailing = false}) {
    return ListTile(
      contentPadding: EdgeInsets.symmetric(horizontal: Get.width / 25),
